...
@Configuration
// @ConditionalOnProperty(value = "es1.uri")
public class ElasticSearchConfig1 {

    @Value("${es.client.client-01.hosts}")
    public Set<String> hostsList;
    @Value("${es.client.client-01.username}")
    public String username;
    @Value("${es.client.client-01.password}")
    public String password;

    @Bean
    public RestClientBuilder restClientBuilder1() {
    ...
    private HttpHost[] makeHttpHost() {
        ...
        throw new RuntimeException("请配置es集群地址 ： es.uri");
    }

    @Bean
    public RestHighLevelClient restHighLevelClient1(@Qualifier("restClientBuilder1") RestClientBuilder restClientBuilder){
